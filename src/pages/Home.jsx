      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8 items-center">
        <div>
          ...
          <p className="text-gray-600 mt-3">
            BookFlow helps you explore a small curated library of titles in
            programming, productivity, creativity, and more.
          </p>
        </div>
        <div className="bg-indigo-50 border border-indigo-100 rounded-xl p-4 text-sm text-slate-700">
          ...
          <p>
            Use the search box and category filter to narrow down the list. Click
            any book to view details and add it to your cart.
          </p>
        </div>
      </div>
